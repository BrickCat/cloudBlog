...
import Index from '@/views/front/index/index.vue';
...
export const indexRouter = {
    ...
    component: () => import('@/views/blog_index/blog_index.vue')
};
...
export const blogRouter = {
    ...
    component: Index,
    children: [
        { path: 'blog_index/:username', meta: {title: 'ITBC - 热门文章'}, name: 'blog_index',component: () => import('@/views/front/article/articleList.vue') },
...
export const appRouter = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: '栏目管理',
                component: () => import('@/views/backed/category/category-table.vue')
            }
        ]
    },
    {
        ...
        component: Main,
        children: [
            { path: 'client', icon:'ios-gear', title: '基础配置', name: 'client', component: () => import('@/views/backed/client/client-settings.vue') },
            { path: 'preference', icon:'wrench', title: '偏好设置', name: 'preference', component: () => import('@/views/backed/client/client-settings.vue') },
            { path: 'Signature', icon:'compose', title: '签名档', name: 'Signature', component: () => import('@/views/backed/client/client-settings.vue') },
            { path: 'statistics', icon:'stats-bars', title: '第三方统计', name: 'statistics', component: () => import('@/views/backed/client/client-settings.vue') },
